...
const grocerymarketlist = document.getElementById('grocerymarketlist')
...
const createGroceryElement = grocery => {
  ...
  groceryElement.classList.add('grocerymarketItem')
...
const addGrocery = newGrocery => {
  grocerymarketlist.appendChild(createGroceryElement(newGrocery))
}
